...
scientist_info = {
    "AdamSmith": ("Adam Smith", tk.PhotoImage(file="adam_smith.png"), '''Contribution: Division of Labor
Year: 1776
Description: Introduced the concept   of division of labour in "The Wealth of Nations," which laid the groundwork for efficient manufacturing processes.
'''),
    "HenryGantt": ("Henry Gantt ", tk.PhotoImage(file="HenryGantt.png"), "Economist and philosopher"),
    "HenryFord": ("Henry Gantt ", tk.PhotoImage(file="henryford.png"), "Economist and philosopher"),
}
