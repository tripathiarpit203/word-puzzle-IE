...
word_list_frame = tk.Frame(main_frame, width=200, bd=2, relief="solid")
word_list_frame.grid(row=0, column=0, sticky="nsew", padx=10, pady=10)

# Create the grid of buttons (60% of width) with a border
grid_frame = tk.Frame(main_frame, bd=2, relief="solid")
grid_frame.grid(row=0, column=1, sticky="nsew")

# Create a frame for the scientist info (20% of width) with a border
info_panel = tk.Frame(main_frame, width=200, bd=2, relief="solid")
...
for word in correct_words:
    btn = tk.Button(word_list_frame, text=word, font="Arial 10 bold", anchor="w", width=15, height=1, bg="lightblue")
