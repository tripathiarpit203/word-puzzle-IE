...
for word in correct_words:
    btn = tk.Button(word_list_frame, text=word, font="Arial 9 bold", anchor="w", width=15, height=1, bg="orange")
...
for i in range(len(crossword)):
    ...
    for j in range(len(crossword[i])):
        frame = tk.Frame(grid_frame, width=30, height=30, padx=2, pady=2)  # Adjusted padding and frame size
