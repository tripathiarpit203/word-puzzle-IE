...
sidebar_frame.grid(row=0, column=0, padx=10, pady=0, sticky="ns")
...
for i in range(len(crossword)):
    ...
    for j in range(len(crossword[i])):
        ...
        btn.bind("<ButtonPress-1>", lambda event: handle_button_event(event, selected_buttons, button_grid, correct_words, word_buttons, image_label))
        btn.bind("<B1-Motion>", lambda event: handle_button_event(event, selected_buttons, button_grid, correct_words, word_buttons, image_label))
        btn.bind("<ButtonRelease-1>", lambda event: handle_button_event(event, selected_buttons, button_grid, correct_words, word_buttons, image_label))
        row.append(btn)
...
image_label.grid(row=0, column=2, padx=10, pady=10, sticky="nsew")
